"""
Django settings for TG_Fatec project.
...
WSGI_APPLICATION = 'TG_Fatec.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(FRONTEND_DIR)
STATICFILES_DIRS = (
